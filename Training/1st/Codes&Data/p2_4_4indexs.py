...
columns=['MaxEigenvalue','Connectivity','Clustering Coefficient'\
...
#plt.show()
plt.savefig(file3 + '/p2' + '/4indexs.png',bbox_inches = 'tight',pad_inches = 0.1)
...
sns.lineplot(data=df,x='MatchID',y='Value',hue='Index')
#plt.show()
plt.savefig(file3 + '/p2' + '/4indexs_ave.png',bbox_inches = 'tight',pad_inches = 0.1)
